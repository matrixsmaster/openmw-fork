...
void OMW::Engine::prepareEngine (Settings::Manager & settings)
{
    ...
    MWInput::InputManager* input = new MWInput::InputManager (mWindow, mViewer, mScreenCaptureHandler, mScreenCaptureOperation, keybinderUser, keybinderUserExists, mGrab);
